...
<head>
    ...
    <title><?php echo e(config('app.name', '24SLIDES')); ?></title>
 ...
 <link rel="stylesheet" href="<?php echo e(asset('bootstrap/font-awesome/css/font-awesome.min.css')); ?>">

    <!-- Styles -->
   
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('bootstrap/css/login.css')); ?>">
    <!-- Bootstrap 4 -->
    ...
    <script src="<?php echo e(asset('bootstrap/js/bootstrap.min.js')); ?>"></script>
        ...
        <link rel="icon" href="<?php echo e(asset('resources/image/icon.ico')); ?>" type="image/png" sizes="32x32">
          <style type="text/css">
            body{
...
<div class="container" id="container">
    ...
    <div class="form-container sign-in-container">
        ...
        <form action="#">
             <img src="<?php echo e(asset('resources/image/logo.png')); ?>" style="width: 200px;"  class="rounded mx-auto d-block">
             <div class="social-container">
...
<?php /**PATH E:\xampp\htdocs\imgpik\resources\views/auth/login.blade.php ENDPATH**/ ?>